...
public class DoctorService {
    ...
    // Metodă sigură: folosește direct repository.save
    ...
    public Optional<Doctor> getDoctorById(String id) { return doctorRepository.findById(id); }
    public List<Doctor> getAllDoctors() { return doctorRepository.findAll(); }
    public List<Doctor> getDoctorsByDepartmentId(String departmentId) { return doctorRepository.findByDepartmentId(departmentId); }
    public void deleteDoctor(String id) { doctorRepository.delete(id); }
